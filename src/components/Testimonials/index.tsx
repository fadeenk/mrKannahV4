...
const TestimonialList: Testimonial[] = [
  {
    ...
    description: "Since I started working with Fadee for coaching and mentorship, my growth has been remarkable. With his guidance, I have advanced my career, secured new opportunities, and gained the confidence to tackle complex challenges. The impact on my career trajectory has been substantial, and I couldn't be happier!",
    title: 'Student',
  }, {
    name: 'Cathy Pucher',
...
function Testimonial({name, img, description, link, title}: Testimonial) {
  return (
		<li className={styles.member}>
			<div className={styles.thumb}><img src={img}/></div>
  ...
  return (
    <section className='hero hero--primary'>
      <div className="container">
        <Heading as="h2" className='hero__title'>What People I have worked with say</Heading>
