...
const NotMaintained: App[] = [
  ...
  },
  {
    ...
    description:
      "This is a userscript that displays prices on anime merch websites in local currency. I built this because I was tired of having to convert the prices manually and wanted to see the prices in my local currency. It supported multiple currencies and websites.",
...
const Abandoned: App[] = [
  ...
  },
  {
    ...
    description:
      "An app that allows you to manage your contacts and keep track of your interactions with them. I wanted to build this app track my contacts and manage my releationship with them.",
  },
  {
    title: "FixQuicker",
    description:
