...
import punta1 from "./images/punta1.jpg";
import punta2 from "./images/punta2.jpg";
import punta3 from "./images/punta3.jpg";
import punta4 from "./images/punta4.jpg";
import punta5 from "./images/punta5.jpg";
import punta6 from "./images/punta6.jpg";
import punta7 from "./images/punta7.jpg";
import punta8 from "./images/punta8.jpg";
import punta9 from "./images/punta9.jpeg";
import punta10 from "./images/punta10.jpeg";
import punta11 from "./images/punta11.jpeg";
import punta12 from "./images/punta12.jpg";
import punta13 from "./images/punta13.jpg";
import punta14 from "./images/punta14.jpg";
import punta15 from "./images/punta15.jpg";
import punta16 from "./images/punta16.jpg";
import punta17 from "./images/punta17.jpg";
import punta18 from "./images/punta18.jpg";
import punta19 from "./images/punta19.jpg";
import punta20 from "./images/punta20.jpg";
import punta21 from "./images/punta21.jpg";
import punta22 from "./images/punta22.jpg";
...
import dec4 from "./images/dec4.jpeg";
...
Given the lack of prospects in my area and after exhausting my network of people I know, I decided to give Habibi Match (a Chaldean focused matching service) a try. I got matched in June with someone who seemed great on the first date, we ended up extending it and having dinner that same day! However, the next date/day she changed 180 degrees and she had a list of demands that she wouldn't even share till after getting engaged. Given the situation, I knew things wouldnt work out so I ended it.

The second/last match was great on the first date however on the second date things didnt go as planned. I was exhausted due to travel and other things going on, so I wasn't fully present during the date. When I reached out to plan the third date, I got friendzoned.

My friend introduced me to a girl on instagram, I reached out to her and things went really well. We talked on the phone and I was planning our date when she ended things because I was not a Chaldean Catholic. She even introduced me to another girl that I reached out to and got ignored.

I have reached the point where, the door is open if I meet someone, but I am done chasing after our people and their unrealistic expectations.
...
Since I got my dad's car, I decided to upgrade it a bit. I added interior lights, led strips and even upgraded door lights. I also added, a wireless chargers and installed a usb c port as an auxulariy port so there are no cables hanging all over the place. Finally, I installed a custom Andorid device that connects to the car's infotainment system and allows me to do wireless Android eventhough that my car doesn't support it. It also allows me to watch YouTube, Netflix and even liveTV while driving.

<Gallery photos={[car1, car2, car3, car4, car5]} />
...
Eventually I hired a management company to help me find a tenant. When the house was re-listed somebody who was interested reached out again and they were good. So I ended up firing the management company and renting directly to the tenant.

### Cleaning out the trash the tenants left

Not only I had to deal with fixing everything that the tenants broke, but they also left a few things in the house that they didnt want. after storing them for a month and being able to legally dispose of them. I threw away the trash, sold couple things that I was able to sell, and spend the rest of my time fixing few things. They had a broken e-bike that was not working and had flat tires. I fixed the electrical issue and replaced the inner tubes so the bike was in a functioning condition. Then I sold it.

<Gallery photos={[ bike1, bike2, bike3]} />

They also left an iPad that was locked. After spending about a month working on it, I managed to unlock it, reset it, and gave it to my mom.
...
Also this year was more challenging in terms of being consistent with the gym. I was able to go a few times, but not at the rate that I would have liked. However, I did join two soccer groups. Which is what I've been doing to stay active. Sometimes I play once a week, other times twice a week. Just depending on the craziness of that week.

### Travel Trips planning!

#### Punta Cana (Dominican Republic)

This trip was the easiest to plan! I only had to coordinate and plan the Miami trip after it and book flights/hotel. Originally, I wanted to do Mexico and South America as well but since MeetingHero.ai wasn't working out as expected. I decided to save up the money and just do Punta Cana and Miami. The Miami part, I didnt need to plan or do anything for it since Luke and Mallory took care of everything for me and hosted me at thier place! The trip was a blast and I got to relax and recharge!
...
I use ClickUp to manage my tasks, notes, schedule, pretty much everything along with my calendar. However, ClickUp decided to start charging for attaching notes and using custom fields. Which I did not appreciate. So I migrated everything into Obsidian. Which I'm loving so far. I had to set up syncing for it which works way better than the Click Up Mobile app. I still need to organize my information Since I did a quick import from click up so things are not optimized for it.
...
Eventhough, it looks like I didnt workout as much this year (which is partially true), I did add two soccer groups to my schedule. Some weeks I would go to both other times to just one.
...
<Gallery
  photos={[july1, july2, july3, july5, july6, july7, july8]}
/>
...
This month was focused on trying to settle everything down. I had few interviews including second interviews so hopefully early next year I will have a job. Also I finished repairing and fixing the mess that the evicted tenants left. I also was finally able to get rid of all the trash they left. I hired a managment company and fired them because I ended up finding a tenant that was a better fit and without the extra fees. I got some consulting work for CourseKey which I used the money (before even getting it) to book a trip to Asia early next year. I booked it so I could have a fun trip, before potentially starting a new job. Also, as a side gig, I DJed for an engagement party. My friends visited for a weekend and we had some fun. Finally, I got to celebrate Christmas and New Year's with my family multiple times and at church. 
